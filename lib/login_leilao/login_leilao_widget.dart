...
class LoginLeilaoWidget extends StatefulWidget {
  const LoginLeilaoWidget({super.key});

  @override
  State<LoginLeilaoWidget> createState() => _LoginLeilaoWidgetState();
}

class _LoginLeilaoWidgetState extends State<LoginLeilaoWidget>
    with TickerProviderStateMixin {
  late LoginLeilaoModel _model;
